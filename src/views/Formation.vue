<template>
    <div class="container">
        ...
        <div class="b-exercices d-flex justify-content-center flex-column mt-3">
            <div class="b-exercices__title d-none d-md-inline">Formation</div>
            <div class="b-exercices__card-idees row">
                <div class="b-exercices__card-idees__item col-md-6 px-md-2" v-for="item in itemIdees" :key="item.id">
        ...
        <div class="row mt-3 pb-5">
            <div class="col-md-6 ml-auto px-md-2 ">
                ...
                <div class="b-card-group__item   d-flex  align-items-center   p-4" v-on:click="toMenuMain">
                    <p class="b-card-group__item__title small mr-auto m-0">Menu Principal</p>
                    <div class="mt-auto">
...
<script>
  import ItemIdeesExercices from '../components/ItemCard'
    export default {
        name: 'Formation',
        data() {
            return {
                itemIdees: [{
                        id: 0,
                        title: 'Formation complète sur la préparation physique en football amateur'
                    },
                    {
                        id: 1,
                    ...
                    {
                        id: 2,
                        title: 'Comment travailler et développer la vitesse et l`endurance en football amateur'
                    },
                    {
                        id: 3,
                        title: 'Comment travailler et développer la motricité chez les jeunes footballeurs'
                    },
                    {
                        id: 4,
                    ...
                    {
                        id: 5,
                        title: 'Guide sur la préparation physique chez les jeunes footballeurs'
                    }
                ]
            }
        },
